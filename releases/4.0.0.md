...
- Added: Graph view for connections lists
- Added: setting: "Show graph in connections lists" (default: on)
- Added: setting to configure connections view open location (default: right sidebar)
- Added: include/exclude by frontmatter for connections lists (Pro)
- Fixed: block embedding should resume after restart if previously failed to complete