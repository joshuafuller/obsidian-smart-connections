...
export const smart_env_config = {
  ...
  components: {
    ...
    connections_footer_view: { render: connections_footer_view_component },
    ...
    connections_settings_lookup_callout: { render: connections_settings_lookup_callout_component },
